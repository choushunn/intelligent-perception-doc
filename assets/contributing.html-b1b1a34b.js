import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as t,c as o,d as n,f as e,b as a,e as i}from"./app-386ae793.js";const d={},c=n("h2",{id:"依赖环境",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#依赖环境","aria-hidden":"true"},"#"),e(" 依赖环境")],-1),p={href:"https://nodejs.org/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://nodejs.org/",target:"_blank",rel:"noopener noreferrer"},m=n("h2",{id:"fork-原始项目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#fork-原始项目","aria-hidden":"true"},"#"),e(" Fork 原始项目")],-1),h={href:"https://github.com/choushunn/intelligent-perception-doc",target:"_blank",rel:"noopener noreferrer"},v=n("li",null,'点击页面右上角的 "Fork" 按钮。这将在您的GitHub账号下创建一个仓库的副本。',-1),b=i(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 克隆项目</span>
